												...
												<table border="0" cellpadding="30" cellspacing="0" width="500" class="flexibleContainer">
													<tr>
														<td style="padding-top:0;" align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<!-- CONTENT TABLE // -->
															<form action="{{ URL::to('/signup/email/varification') }}" method="POST" target="_blank">
																<table border="0" cellpadding="0" cellspacing="0" width="50%" class="emailButton" style="background-color: #3498DB;">
																	<tr>
																				{{ csrf_field() }}
																				<input type="hidden" name="email" value="{{ $email }}">
																				<input type="hidden" name="password" value="{{ $password }}">
																				<button class="submit buttonContent" style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%; background-color: #3998dc;">Confirmation</button>		
																	</tr>
																</table>
															</form>
															<!-- // CONTENT TABLE -->
